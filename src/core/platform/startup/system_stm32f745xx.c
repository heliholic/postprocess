...
/*
 * STM32F745 bring-up: everything between reset and the C runtime.
 *
...
/* The vector table, from startup_stm32f745xx.s. */
...
void systemPreInit(void)
{
    ...
    /*
     * 216 MHz at scale 1 needs 7 wait states, RM0385 table 7. The flash
...
static void mpuInit(void)
{
    static const ARM_MPU_Region_t regions[] = {
        ...
        },
        {
             ...
             * maintenance.
             */
            .RBAR = ARM_MPU_RBAR(1U, 0x2004C000U),
