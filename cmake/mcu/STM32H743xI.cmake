# STM32H743xI — Cortex-M7 r1p1, 2 MB flash, rev V silicon or later.
#
# ST's xI suffix is the flash size, 2M; the 1M part is xG and is a separate MCU
# with its own two files, since the memory map differs. The x denotes
# pinout, package and temperature grade, none of which affect the build.
#
# The build cannot check the revision. SystemInit() reads it and halts below
# rev V, which 480 MHz requires.
#
...
# below, and the memory map in src/core/platform/linker/STM32H743xI.ld.
...
set(RFX_MCU_DEFINES
    ...
    # flash-agnostic — the register map is the same on xG and xI — so this is
...
set(RFX_CMSIS_HEADER stm32h743xx.h)
...
set(RFX_MCU_STARTUP startup_stm32h743xx.s)
set(RFX_MCU_SYSTEM  system_stm32h743xx.c)
